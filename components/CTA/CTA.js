    ...
    >
      <div className="text-center px-4 sm:px-6 max-w-xl text-white">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
          <Typewriter
            words={['Ready to Launch Your Client-Getting Website?']}
            loop={false}
            cursor
            typeSpeed={50}
          />
        ...
        <p className="mb-6 text-xs sm:text-sm md:text-base">
          Launch your professional coaching website quickly with our proven process — designed to attract ideal clients, grow your business, and amplify your impact.
        </p>
